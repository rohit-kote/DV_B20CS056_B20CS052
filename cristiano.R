...
# Load data
season_data <- read.csv("D:/PDFs/4th year-2nd sem/DV/DV_project/cris_season_wise_meta_df.csv")
shots_data <- read.csv("D:/PDFs/4th year-2nd sem/DV/DV_project/cris_shots_df.csv")
cr7_data <- read.csv("D:/PDFs/4th year-2nd sem/DV/DV_project/cr7.csv")
