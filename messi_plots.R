...
loadMessiData <- function() {
  season_data <- read.csv("D:/Btech/year4_sem2/Data_visulisation/project/messi_season_wise_meta_df.csv")
  shots_data <- read.csv("D:/Btech/year4_sem2/Data_visulisation/project/messi_shots_df.csv")
  messi_data <- read.csv("D:/Btech/year4_sem2/Data_visulisation/project/messi.csv")
  return(list(season_data = season_data, shots_data = shots_data, messi_data = messi_data))
}

# Function to generate plots for Cristiano Ronaldo
generateMessiPlot <- function(data, plotType) {
  season_data <- data$season_data
  shots_data <- data$shots_data
  messi_data <- data$messi_data
